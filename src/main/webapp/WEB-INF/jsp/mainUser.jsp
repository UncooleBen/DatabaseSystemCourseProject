    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav">
                ...
                <li><a href="news?action=list&page=1"><i class="icon-chevron-right"></i>新闻</a></li>
                <li><a href="building?action=view&page=1"><i class="icon-chevron-right"></i>场地介绍</a></li>
                <li><a href="building?action=list&page=1"><i class="icon-chevron-right"></i>场地预约</a></li>
                <li><a href="record?action=list&page=1"><i class="icon-chevron-right"></i>预约记录</a></li>
