...
public interface UserDao {
     ...
     */
    List<User> queryAllUsers(int skip, int limit);

    /**
     * Get the total number of users from 't_user' of the database
     *
     * @return A int of number of users
     */
    int queryTotalUserNumber();
