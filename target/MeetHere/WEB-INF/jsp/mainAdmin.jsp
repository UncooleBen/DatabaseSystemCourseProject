    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar">
            <ul class="nav nav-list bs-docs-sidenav">
                ...
                <li><a href="user?action=list&page=1"><i class="icon-chevron-right"></i>用户管理</a></li>
                <li><a href="news?action=list&page=1"><i class="icon-chevron-right"></i>新闻管理</a></li>
                <li><a href="comment?action=list&page=1"><i class="icon-chevron-right"></i>留言管理</a></li>
                <li><a href="building?action=list&page=1"><i class="icon-chevron-right"></i>场地管理</a></li>
                <li><a href="record?action=list&page=1"><i class="icon-chevron-right"></i>预约管理</a></li>
